...
var M = (e) => {
  const c = (0, import_react.useMemo)(() => ({ ...e }), [e]), { defaultValue: r, options: i = {}, value: n, children: f, render: l } = c, a = (0, import_react.useMemo)(() => u(i, c), [i, c]), h = (0, import_react.useRef)(null), t = (0, import_react.useRef)(void 0);
  (0, import_react.useImperativeHandle)(
    ...
    const g = () => {
      ...
      }), t.current = (((C = esm_default) == null ? void 0 : C.default) || esm_default)(h.current, a), t.current && n !== void 0 && t.current.setDate(n, false), e.onCreate && e.onCreate(t.current);
    }, m = () => {
  ...
  const A = (0, import_react.useCallback)((g) => {
    h.current = g;
  }, []);
  if (l)
  ...
  return i.wrap ? (0, import_jsx_runtime.jsx)("div", { className: "flatpickr", ref: A, children: f }) : (0, import_jsx_runtime.jsx)(
    "input",
    {
      onChange: x,
      ...c,
